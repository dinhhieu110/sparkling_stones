						...
						<div class="content-body">
							<div class="d-flex align-items-center">
								...
								<div class="pt-2">
									...
									<p>
										Email: myusername@gmail.com, Phone: +1234567890988 <a href="#"
											class="px-2"><i class="fa fa-pen"></i></a>
									</p>
								</div>
							</div>
							...
							<a href="#" class="btn btn-light border"> <i
								class="me-2 fa fa-plus"></i> Add new address
							</a>
								...
								<div class="card-body pb-0">
									<header class="d-lg-flex">
										<div class="flex-grow-1">
											<h6 class="mb-0">
												Order ID: 8924 <i class="dot"></i> <span
									...
									<div class="row">
										...
										<div class="col-lg-4 border-start">
											...
											<p class="m-0">
												United States <br /> 3601 Old Capitol Trail, Unit A-7,
												Suite 170777, Wilmington, DE 19808
											</p>
										</div>
										<div class="col-lg-4 border-start">
