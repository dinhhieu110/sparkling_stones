							...
							<div
								...
								<div class="pt-2 ms-3 me-auto">
									<div class="mb-2">
										...
										<span class="mx-1">${profile.getFirstName()}
											${profile.getLastName()}</span>
									</div>
									<div class="mb-2">
										<h6 class="d-inline mb-0">Email:</h6>
										<span class="mx-1">${profile.getEmail()}</span>
									</div>

									<div class="mb-2">
										<h6 class="d-inline mb-0">Phone:</h6>
										<span class="mx-1">${profile.getPhone()}</span>
									</div>
